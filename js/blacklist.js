...
function populateEditForm(data) {
    ...
    if (!editIdField) {
        ...
        document.querySelector("#blacklist_modal_form").appendChild(editIdField);
    }
    ...
    if (!idField) {
        ...
        idField.type = "hidden";
        idField.name = "id";
        document.querySelector("#blacklist_modal_form").appendChild(idField);
    }
    ...
    var submitBtn = document.querySelector("#blacklist_modal_form button[type='submit']");
