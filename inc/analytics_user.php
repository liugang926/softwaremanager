...
if ($selected_user) {
    ...
    // Get user real name
    $user_realname = '';
    $sql = "SELECT DISTINCT user_realname FROM `glpi_plugin_softwaremanager_scandetails`
...
// Get user statistics
$user_rows = [];
$sql = "SELECT user_name, user_realname,
               COUNT(*) as total_software,
...
// Summary statistics
$summary_stats = ['total_users' => 0, 'safe_users' => 0, 'medium_risk_users' => 0, 'high_risk_users' => 0];
$sql = "SELECT
