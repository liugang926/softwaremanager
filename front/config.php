...
// GLPI 11.x: 使用完整路径，因为 $_SERVER['PHP_SELF'] 在路由模式下返回 /public/index.php
$baseUrl = $CFG_GLPI['root_doc'] . '/plugins/softwaremanager/front/config.php';
foreach ([
   ...
   echo "<a class='$cls' href='$url'>".htmlspecialchars($tabLabel)."</a>";
}
echo "</div>";
